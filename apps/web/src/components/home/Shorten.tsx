...
export const Shorten = () => {
  ...
  return (
    <form
      className="flex w-full flex-col rounded-md bg-dark-violet bg-shorten-mobile bg-right-top bg-no-repeat p-4 md:bg-shorten-desktop md:bg-cover md:p-16"
            ...
            <div className="flex w-full flex-col">
              <input
                ...
                className={cn(
                  ...
                  field.state.meta.isValid ? "border-grayish-violet" : "border-red",
                )}
              />
